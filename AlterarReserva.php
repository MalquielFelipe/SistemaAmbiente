...
<form id="form-alterar-reserva" method="post" action="updateReserva.php">
    ...
    <div>
        ...
        <input name="horario" id="horario" type="datetime-local" value="<?php echo htmlspecialchars($reserva['horario']); ?>" required />
    </div>

    <div>
        <label for="horario_fim">Horário Fim:</label>
        <input name="horario_fim" id="horario_fim" type="datetime-local" value="<?php echo htmlspecialchars($reserva['horario_fim']); ?>" required />
    </div>
